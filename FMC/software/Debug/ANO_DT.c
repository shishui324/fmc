...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;     
//            ANO_DT_Send_Senser(var[0],var[1],var[2],
//                               var[3],var[4],var[5],
//                                  var[6],var[7],var[8]);            //匿名上位机示波器     
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_power = 0;
//		ANO_DT_Send_Power((uint16)(BAT_VAL*990/65535+66),0);
	}
///////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid1)
	{
		f.send_pid1 = 0;
//		ANO_DT_Send_PID(11,ctrl_1.PID[PIDROLL].kp,ctrl_1.PID[PIDROLL].ki,ctrl_1.PID[PIDROLL].kd,
...
//                ANO_DT_Send_PID(1,Motor.kp/1000,Motor.ki/1000,Motor.kd/1000,Servo.kp/1000,0,Servo.kd/1000,
//                                 Servo.kp_2/1000,0,Servo.kd_2/1000);
	}	
///////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid2)
	{
		f.send_pid2 = 0;
//		ANO_DT_Send_PID(12,ctrl_1.PID[PID4].kp,ctrl_1.PID[PID4].ki,ctrl_1.PID[PID4].kd,
...
///////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid3 = 0;
//		ANO_DT_Send_PID(13,ctrl_2.PID[PIDROLL].kp,ctrl_2.PID[PIDROLL].ki,ctrl_2.PID[PIDROLL].kd,
...
{
        uart_putbuff (DEBUG_PORT,dataToSend, length);
}
...
//                        Motor.INH = 0;          //停车
    ...
    {
//        Motor.kp  = (vint16)(*(data_buf+4)<<8)|*(data_buf+5) ;
//        Motor.ki  = (vint16)(*(data_buf+6)<<8)|*(data_buf+7) ;
//        Motor.kd  = (vint16)(*(data_buf+8)<<8)|*(data_buf+9) ;
//        Servo.kp = (vint16)(*(data_buf+10)<<8)|*(data_buf+11) ;
//        val = (vint16)(*(data_buf+12)<<8)|*(data_buf+13) ;
//        Servo.kd = (vint16)(*(data_buf+14)<<8)|*(data_buf+15);
//        Servo.kp_2 	= (vint16)(*(data_buf+16)<<8)|*(data_buf+17);
////        Servo.ki 	= 0.001*( (vint16)(*(data_buf+18)<<8)|*(data_buf+19) );
//        Servo.kd_2	= (vint16)(*(data_buf+20)<<8)|*(data_buf+21);
//        ANO_DT_Send_Check(*(data_buf+2),sum);
////	Param_SavePID();
    }
    if(*(data_buf+2)==0X11)								//PID2
    {
//        ctrl_1.PID[PID4].kp 	= 0.001*( (vint16)(*(data_buf+4)<<8)|*(data_buf+5) );
//        ctrl_1.PID[PID4].ki 	= 0.001*( (vint16)(*(data_buf+6)<<8)|*(data_buf+7) );
//        ctrl_1.PID[PID4].kd 	= 0.001*( (vint16)(*(data_buf+8)<<8)|*(data_buf+9) );
//        ctrl_1.PID[PID5].kp 	= 0.001*( (vint16)(*(data_buf+10)<<8)|*(data_buf+11) );
//        ctrl_1.PID[PID5].ki 	= 0.001*( (vint16)(*(data_buf+12)<<8)|*(data_buf+13) );
//        ctrl_1.PID[PID5].kd 	= 0.001*( (vint16)(*(data_buf+14)<<8)|*(data_buf+15) );
//        ctrl_1.PID[PID6].kp	= 0.001*((vint16)(*(data_buf+16)<<8)|*(data_buf+17) );
//        ctrl_1.PID[PID6].ki 	= 0.001*( (vint16)(*(data_buf+18)<<8)|*(data_buf+19) );
...
//				Param_SavePID();
    ...
    {	
//        ctrl_2.PID[PIDROLL].kp  = 0.001*( (vint16)(*(data_buf+4)<<8)|*(data_buf+5) );
//        ctrl_2.PID[PIDROLL].ki  = 0.001*( (vint16)(*(data_buf+6)<<8)|*(data_buf+7) );
//        ctrl_2.PID[PIDROLL].kd  = 0.001*( (vint16)(*(data_buf+8)<<8)|*(data_buf+9) );
//        ctrl_2.PID[PIDPITCH].kp = 0.001*( (vint16)(*(data_buf+10)<<8)|*(data_buf+11) );
//        ctrl_2.PID[PIDPITCH].ki = 0.001*( (vint16)(*(data_buf+12)<<8)|*(data_buf+13) );
//        ctrl_2.PID[PIDPITCH].kd = 0.001*( (vint16)(*(data_buf+14)<<8)|*(data_buf+15) );
//        ctrl_2.PID[PIDYAW].kp 	= 0.001*( (vint16)(*(data_buf+16)<<8)|*(data_buf+17) );
//        ctrl_2.PID[PIDYAW].ki 	= 0.001*( (vint16)(*(data_buf+18)<<8)|*(data_buf+19) );
//        ctrl_2.PID[PIDYAW].kd 	= 0.001*( (vint16)(*(data_buf+20)<<8)|*(data_buf+21) );
        ANO_DT_Send_Check(*(data_buf+2),sum);
//				Param_SavePID();
    }
